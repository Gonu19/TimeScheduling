...
export function LandingScreen({ onCreate, onLoadStored }: Props) {
  ...
  const create = () => {
    ...
    // 백엔드와 동일하게 startDate 기준 7일간의 후보 날짜 배열을 자동 생성
        ...
        <div className="grid lg:grid-cols-[1fr_360px] gap-6 items-start">
          <Card>
            <CardHeader>
              ...
              <CardDescription>회원가입 없이 30초 안에 시작하세요.</CardDescription>
            </CardHeader>
                ...
                <div className="space-y-2">
                  {members.map((m, i) => (
                    ...
                    >
                      ...
                      />
                      <label className="flex items-center gap-1.5 text-gray-600 text-sm px-1">
                        <Star
