...
| 스케줄 추천안 도출 및 확정(가제) | 3가지 추천안 도출 및 제시 |     GET     |          /api/sessions/{sessionId}/recommendations          | 개발 후  | [[3.1 Schedule Recommendation]]    |
...
|                     | 스케줄 긴급 수정(관리자만) |    PATCH    |              /api/sessions/{sessionId}/result               | 개발 후  | [[4.2 Manual Overried]]            |